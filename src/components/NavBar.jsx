...
const NavBar = () => {
  ...
  return (
    <div className='w-full container overflow:hidden absolute z-10 flex justify-between items-center h-24'>
      {/* Desktop View */}
      <div className='w-full mx-auto  p-3 flex justify-between items-center'>
        ...
        <div className='hidden ml-[60px] sm:flex items-center  lg:text-[15px] md:text-[12px] space-x-6 md:space-x-4 text-white'>
          ...
          <Link to="cantact" spy={true}  smooth={true} offset={50} duration={500}  className='hover:text-[#F9DEA5]'>Contact</Link>
        </div>
        </div>
      ...
      <div className={nav ? 'fixed top-0 left-0 h-screen w-full bg-[#262126] text-white flex flex-col justify-center items-center z-30 duration-300' : 'fixed top-[-100%] left-0 bg-[#262126] h-screen w-full  z-10 duration-300'}>
        <AiOutlineClose onClick={() => setNav(!nav)} className='absolute top-12 right-12 w-[18.3px] h-[18.3px] cursor-pointer'  />

        {/* Centered Navigation Links */}
        <div className='flex w-[145px] h-[260px] flex-col space-y-6    items-center'>
        ...
        <div className='relative group'>
          ...
          {dropdownOpen && (
            <div className="absolute -right-14 rounded z-10 mt-2 w-[200px] p-2 ease-in-out duration-300 text-black bg-white">
          ...
          <div className='flex items-center  flex-col space-y-6 mt-[40px]'>
            <button className='text-[20px] px-[100px] py-[7px] border rounded-md border-white'>Sign in</button>
            <button className='bg-[#F9DEA5] text-[20px] text-black px-[100px] py-[7px] border rounded-md'>Sign up</button>
          </div>
            

           {/* Socials */}
           <div className='flex absolute  items-center justify-center space-x-4 bottom-6'>
