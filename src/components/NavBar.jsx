...
const NavBar = () => {
  ...
  return (
    <div className='w-full container overflow:hidden absolute z-10 flex justify-between items-center h-24'>
      ...
      <div className={nav ? 'fixed top-0 left-0 h-screen w-full bg-[#262126] text-white flex flex-col justify-between items-center z-30 duration-300' : 'fixed top-[-100%] left-0 bg-[#262126] h-screen w-full z-10 duration-300'}>
        ...
        <div className='flex items-center justify-center space-x-4 mt-auto mb-3'>
